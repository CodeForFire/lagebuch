...
public sealed partial class IncidentWorkspaceViewModel : ObservableObject
{
    ...
    // requires a platform that actually supports rendering (see IIncidentPdfExporter) — Android
    // supplies NoopIncidentPdfExporter, so the button stays hidden there too.
