...
public static class SnapshotMapper
{
    public static IncidentSnapshot ToSnapshot(Incident incident)
    {
        ...
        return new IncidentSnapshot(
            ...
            incident.ClosedAt,
            incident.ClosedBy,
            incident.Checklist.Select(c => new ChecklistItemDto(c.Id, c.Text, c.IsDone, c.Note)).ToList(),
    ...
    public static Incident FromSnapshot(IncidentSnapshot snapshot)
    {
        ...
        return Incident.Rehydrate(
            ...
            snapshot.ClosedAt,
            snapshot.ClosedBy,
            snapshot.Checklist.Select(c => ChecklistItem.Rehydrate(c.Id, c.Text, c.IsDone, c.Note)),
