...
public interface IIncidentSession
{
    ...
    /// <paramref name="createdAt"/> optionally anchors the task to an existing ETB entry's own
    /// timestamp (#247) instead of "now"; null keeps the original behaviour.</summary>
    void AddTask(
        string text,
        string? assignee,
